...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>SIT WISATA MALANG</title>

	<link rel="icon" href="admin/img/kota_malang.png">
	...
	<header id="header">
		...
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.php"><img src="admin/img/kota_malang.png" width="50px" height="50px" alt="" title="" /></a>
					<a href="index.php"><img src="admin/img/kabupaten_malang.png" width="50px" height="50px" alt="" title="" /></a>
				</div>
